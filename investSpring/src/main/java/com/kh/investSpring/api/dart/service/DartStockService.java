    ...
    public void syncStockTotals() {
        ...
        for (Map<String, Object> corp : corpList) {
            ...
            try {
                ...
                String corpCode =
                        String.valueOf(corp.get("CORP_CODE"));

                String stockCode =
                        String.valueOf(corp.get("STOCK_CODE"));

                StockTotalQuantityDto dto =
                        requestStockTotals(
                                corpCode,
                                stockCode,
                                String.valueOf(year),
