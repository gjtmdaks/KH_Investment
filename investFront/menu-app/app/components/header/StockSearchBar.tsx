...
export default function StockSearchBar() {
  ...
  const showRecentPanel =
    open && !trimmedKeyword && recentSearches.length > 0;
        ...
        <div className={styles.dropdown}>
          ...
          {!trimmedKeyword && (
            <div className={styles.popularHeader}>
              <Link href="/main/screener" className={styles.moreLink}>
                인기있는 주식 골라보기
              </Link>
            </div>
          )}
              ...
              <div className={styles.resultList}>
                {items.map((item) => (
                  <Link
                    ...
                    onMouseDown={() => rememberSearch(trimmedKeyword)}
                    onClick={clearSearch}
                  >
